...
public class RestaurantController {
	...
	public String addMenuItemToRestaurant(@RequestParam(value = NAME) String name,
		...
		final Set<MenuItem> menuItems = getRestaurantService().addMenuItemToRestaurant(
				restaurantService.getCurrentUserRestaurant(), menuItem);
	...
	private MenuItem createMenuItemFromRequest(String name, String ingredients, String price, MultipartFile photo)
			throws IOException {
